...
describe('Technique QW-HTML-T28', function() {

  const tests = [
    {
      url: 'http://accessible-serv.lasige.di.fc.ul.pt/~aestriga/TesteHTML-T28/test1.html',
      outcome: 'warning'
    },
    {
      url: 'http://accessible-serv.lasige.di.fc.ul.pt/~aestriga/TesteHTML-T28/test2.html',
      outcome: 'warning'
    },
    {
      url: 'http://accessible-serv.lasige.di.fc.ul.pt/~aestriga/TesteHTML-T28/test3.html',
      outcome: 'warning'
    },
    {
  ...
  for (const test of tests || []) {
    ...
    describe(`${test.outcome.charAt(0).toUpperCase() + test.outcome.slice(1)} example ${i}`, function () {
      it(`should have outcome="${test.outcome}"`, async function () {
        ...
        expect(report.techniques['QW-HTML-T28'].metadata.outcome).to.be.equal(test.outcome);
        let qwId = 'QW-HTML-T28';
